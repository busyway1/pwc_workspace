...
import { CircleAlert, HardDrive, PlugZap, RefreshCcw, Smartphone, X, Zap } from "lucide-solid";
              ...
              <div class="space-y-4">
                ...
                <div class="bg-gray-2/30 border border-gray-6/50 rounded-2xl p-5 space-y-4">
                  ...
                  <div class="bg-gray-1 p-4 rounded-xl border border-gray-6 space-y-3">
                    ...
                    <Show when={openworkRestartError() || opencodeRestartError() || openworkServerRestartError()}>
                      <div class="text-xs text-red-11 bg-red-3/50 border border-red-6 rounded-lg p-2">
                        {openworkRestartError() || opencodeRestartError() || openworkServerRestartError()}
                      </div>
                    </Show>
                  </div>
                    ...
                    >
                      {(caps) => (
                        <div class="grid md:grid-cols-2 gap-2 text-xs text-gray-11">
                          ...
                          <div>Proxy (OpenCode): {caps().proxy?.opencode ? "enabled" : "disabled"}</div>
                          <div>
                            Browser tools: {(() => {
